...
const WorkShift = () => {
  ...
  const handleInputChange = (e) => {
    ...
    setFormData((prev) => {
      ...
      setFormErrors((prevErrors) => {
        ...
        if (name === "timeStart" || name === "timeEnd") {
          newErrors.workingHours = validateField(
            "workingHours",
  ...
  if (loading)
    return <div className={styles.clinicLoading}>Loading work shifts...</div>;
  if (error)
    return (
  ...
  const submitDisabled =
    formLoading || (submitAttempted && !isFormValid(formErrors));
