...
// ── Required fields that must be filled for the Save button to be enabled ────
const REQUIRED_FIELDS = ['firstName', 'mobile', 'gender', 'age'];
...
const AddPatient = ({ isOpen, onClose, onSuccess }) => {
  ...
  // ── Button cooldown: disabled 2s after any click ──────────────────────────
  ...
  const saveButtonEnabled = !formLoading && !submitCooldown;
  ...
  const handleSubmit = async (e) => {
    ...
    if (!isRequiredFilled()) {
      showPopup('Please fill all required fields before saving.', 'warning');
      return;
    }
    ...
    try {
      ...
      showPopup(err.message || 'Failed to add patient.', 'error');
    } finally {
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className={styles.addSection}>
                ...
                <div className={styles.addFormGrid}>
                  ...
                  <div className={styles.addFormGroup}>
                    <label>Marital Status <span className={styles.required}>*</span></label>
                    <select
                      required
                      name="maritalStatus"
