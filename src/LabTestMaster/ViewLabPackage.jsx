...
const ViewLabPackage = ({
  ...
  const handleDeleteItemClick = (item) => {
    setPendingDeleteId(item.packageItemId);
    setPendingDeleteName(item.testName);
  ...
  return (
    <>
      ...
      <ConfirmPopup
        ...
        message="Remove this test from the package?"
        subMessage={pendingDeleteName ? `"${pendingDeleteName}" will be removed from this package.` : ''}
