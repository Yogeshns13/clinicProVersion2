...
const UpdatePatientVisit = ({ isOpen, onClose, onSuccess, visitId }) => {
  ...
  // ── Form completeness: visitDate + visitTime required ──
  const isFormComplete = !!formData.visitDate && !!formData.visitTime;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showPopup('Visit updated successfully!', 'success');
      setTimeout(() => {
      ...
      showPopup(err.message || 'Failed to update patient visit.', 'error');
    } finally {
      setSaving(false);
    }
  };
              ...
              <>
                ...
                <div className={styles.formSection}>
                  ...
                  <div className={`${styles.formRow} ${styles.vitalsRow}`}>
                    <div className={styles.formGroup}>
                      <label className={styles.formLabel}>Systolic BP (mmHg) <span className={styles.required}>*</span></label>
                      <input
                        required
                        type="text"
                        name="bpSystolic"
                    ...
                    <div className={styles.formGroup}>
                      <label className={styles.formLabel}>Diastolic BP (mmHg)<span className={styles.required}>*</span></label>
                      <input
                        required
                        type="text"
                        name="bpDiastolic"
                    ...
                    <div className={styles.formGroup}>
                      <label className={styles.formLabel}>Temperature (°F)<span className={styles.required}>*</span></label>
                      <input
                        required
                        type="text"
                        name="temperature"
          ...
          {!loading && !(error?.status >= 400 || error?.code >= 400) && (
            <div className={styles.updateVisitFooter}>
              ...
              <button
                ...
                disabled={saving || !isFormComplete || saveCooldown}
